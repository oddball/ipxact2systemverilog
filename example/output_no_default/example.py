...
# with the command '/home/labgrid/Thomas_vreys/ipxact2systemverilog/.venv/bin/ipxact2py --srcFile example/input/test.xml --destDir example/output_no_default --config example/input/no_default.ini'
#
...
class power_enum(IntEnum):
    false = 0  # disable
    true = 1  # enable


# write something useful for field power2
class power2_enum(IntEnum):
    false = 0
    true = 1
...
class reg2_type(Register):
    ...
    def __init__(
        ...
        # [0]
        # write something useful for field power
        self._power = EnumField(
            self,
            bit_width=1,
            bit_offset=0,
            access="read-write",
            enum_type=power_enum,
        )
        # [1]
        # write something useful for field power2
        self._power2 = EnumField(
            self,
            bit_width=1,
            bit_offset=1,
            access="read-write",
            enum_type=power2_enum,
        )
        # [3:2]
        # which monkey
    ...
    @power.setter
    def power(self, value: power_enum):
    ...
    @power2.setter
    def power2(self, value: power2_enum):
