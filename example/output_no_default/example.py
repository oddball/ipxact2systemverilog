...
# with the command '/Users/andreas/workgit/ipxact2systemverilog/venv/bin/ipxact2py --srcFile example/input/test.xml --destDir example/output_no_default --config example/input/no_default.ini'
#
