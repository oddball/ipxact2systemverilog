 ...
 *  with the command 'ipxact2c --srcFile example/input/test.xml --destDir example/output_no_default --config example/input/no_default.ini'
 *
...
#define EXAMPLE_REG0_BYTE0_MIN 	0x00
#define EXAMPLE_REG0_BYTE0_MAX 	0x07
...
#define EXAMPLE_REG1_FIELD0_MIN 	0x00000004
#define EXAMPLE_REG1_FIELD0_MAX 	0x00000014
